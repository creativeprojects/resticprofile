...
func NewFilterReadCloser(read ReadFunc, closer CloseFunc) io.ReadCloser {
	return &filterReadCloser{*NewFilterReader(read).(*filterReader), closer}
}
