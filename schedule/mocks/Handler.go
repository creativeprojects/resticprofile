...
func (_m *Handler) CreateJob(job *config.ScheduleConfig, schedules []*calendar.Event, permission string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*config.ScheduleConfig, []*calendar.Event, string) error); ok {
...
func (_c *Handler_CreateJob_Call) Run(run func(job *config.ScheduleConfig, schedules []*calendar.Event, permission string)) *Handler_CreateJob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*config.ScheduleConfig), args[1].([]*calendar.Event), args[2].(string))
	})
	return _c
}
...
func (_c *Handler_CreateJob_Call) RunAndReturn(run func(*config.ScheduleConfig, []*calendar.Event, string) error) *Handler_CreateJob_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Handler) DisplayJobStatus(job *config.ScheduleConfig) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*config.ScheduleConfig) error); ok {
		r0 = rf(job)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Handler_DisplayJobStatus_Call) Run(run func(job *config.ScheduleConfig)) *Handler_DisplayJobStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*config.ScheduleConfig))
	})
	return _c
}
...
func (_c *Handler_DisplayJobStatus_Call) RunAndReturn(run func(*config.ScheduleConfig) error) *Handler_DisplayJobStatus_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Handler) RemoveJob(job *config.ScheduleConfig, permission string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*config.ScheduleConfig, string) error); ok {
...
func (_c *Handler_RemoveJob_Call) Run(run func(job *config.ScheduleConfig, permission string)) *Handler_RemoveJob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*config.ScheduleConfig), args[1].(string))
	})
	return _c
}
...
func (_c *Handler_RemoveJob_Call) RunAndReturn(run func(*config.ScheduleConfig, string) error) *Handler_RemoveJob_Call {
	_c.Call.Return(run)
	return _c
}
