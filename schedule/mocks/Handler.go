...
import (
	...
	user "github.com/creativeprojects/resticprofile/user"
)
...
func (_m *Handler) CheckPermission(_a0 user.User, p schedule.Permission) bool {
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(user.User, schedule.Permission) bool); ok {
		r0 = rf(_a0, p)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_e *Handler_Expecter) CheckPermission(_a0 interface{}, p interface{}) *Handler_CheckPermission_Call {
	return &Handler_CheckPermission_Call{Call: _e.mock.On("CheckPermission", _a0, p)}
}
...
func (_c *Handler_CheckPermission_Call) Run(run func(_a0 user.User, p schedule.Permission)) *Handler_CheckPermission_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(user.User), args[1].(schedule.Permission))
	})
	return _c
}
