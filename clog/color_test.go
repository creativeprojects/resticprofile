...
//
// Console coloring shamelessly copied from https://github.com/fatih/color
// (the repository is marked as archived and no longer maintained)
//
...
func TestColorVisual(t *testing.T) {
	...
	fmt.Fprintf(OutputWriter, "this is a %s and this is %s.\n", put("warning"), warn("error"))

	info := New(FgWhite, BgGreen).SprintFunc()
	fmt.Fprintf(OutputWriter, "this %s rocks!\n", info("package"))
	...
	fmt.Fprintln(OutputWriter, BlackString("black"))
	fmt.Fprintln(OutputWriter, RedString("red"))
	fmt.Fprintln(OutputWriter, GreenString("green"))
	fmt.Fprintln(OutputWriter, YellowString("yellow"))
	fmt.Fprintln(OutputWriter, BlueString("blue"))
	fmt.Fprintln(OutputWriter, MagentaString("magenta"))
	fmt.Fprintln(OutputWriter, CyanString("cyan"))
	fmt.Fprintln(OutputWriter, WhiteString("white"))
	fmt.Fprintln(OutputWriter, HiBlackString("hblack"))
	fmt.Fprintln(OutputWriter, HiRedString("hred"))
	fmt.Fprintln(OutputWriter, HiGreenString("hgreen"))
	fmt.Fprintln(OutputWriter, HiYellowString("hyellow"))
	fmt.Fprintln(OutputWriter, HiBlueString("hblue"))
	fmt.Fprintln(OutputWriter, HiMagentaString("hmagenta"))
	fmt.Fprintln(OutputWriter, HiCyanString("hcyan"))
	fmt.Fprintln(OutputWriter, HiWhiteString("hwhite"))
}
