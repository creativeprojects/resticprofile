...
// Command provides a mock function for the type SectionInfo
func (_mock *SectionInfo) Command() restic.CommandIf {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() restic.CommandIf); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *SectionInfo_Command_Call) Return(commandIf restic.CommandIf) *SectionInfo_Command_Call {
	_c.Call.Return(commandIf)
	return _c
}
...
// Description provides a mock function for the type SectionInfo
func (_mock *SectionInfo) Description() string {
	ret := _mock.Called()
...
func (_c *SectionInfo_Description_Call) Return(s string) *SectionInfo_Description_Call {
	_c.Call.Return(s)
	return _c
}
...
// IsAllOptions provides a mock function for the type SectionInfo
func (_mock *SectionInfo) IsAllOptions() bool {
	ret := _mock.Called()
...
func (_c *SectionInfo_IsAllOptions_Call) Return(b bool) *SectionInfo_IsAllOptions_Call {
	_c.Call.Return(b)
	return _c
}
...
// IsClosed provides a mock function for the type SectionInfo
func (_mock *SectionInfo) IsClosed() bool {
	ret := _mock.Called()
...
func (_c *SectionInfo_IsClosed_Call) Return(b bool) *SectionInfo_IsClosed_Call {
	_c.Call.Return(b)
	return _c
}
...
// IsCommandSection provides a mock function for the type SectionInfo
func (_mock *SectionInfo) IsCommandSection() bool {
	ret := _mock.Called()
...
func (_c *SectionInfo_IsCommandSection_Call) Return(b bool) *SectionInfo_IsCommandSection_Call {
	_c.Call.Return(b)
	return _c
}
...
// Name provides a mock function for the type SectionInfo
func (_mock *SectionInfo) Name() string {
	ret := _mock.Called()
...
func (_c *SectionInfo_Name_Call) Return(s string) *SectionInfo_Name_Call {
	_c.Call.Return(s)
	return _c
}
...
// OtherPropertyInfo provides a mock function for the type SectionInfo
func (_mock *SectionInfo) OtherPropertyInfo() config.PropertyInfo {
	ret := _mock.Called()
...
func (_c *SectionInfo_OtherPropertyInfo_Call) Return(propertyInfo config.PropertyInfo) *SectionInfo_OtherPropertyInfo_Call {
...
// Properties provides a mock function for the type SectionInfo
func (_mock *SectionInfo) Properties() []string {
	ret := _mock.Called()
...
func (_c *SectionInfo_Properties_Call) Return(strings []string) *SectionInfo_Properties_Call {
...
// PropertyInfo provides a mock function for the type SectionInfo
func (_mock *SectionInfo) PropertyInfo(name string) config.PropertyInfo {
...
func (_c *SectionInfo_PropertyInfo_Call) Return(propertyInfo config.PropertyInfo) *SectionInfo_PropertyInfo_Call {
	_c.Call.Return(propertyInfo)
	return _c
}

func (_c *SectionInfo_PropertyInfo_Call) RunAndReturn(run func(name string) config.PropertyInfo) *SectionInfo_PropertyInfo_Call {
	_c.Call.Return(run)
	return _c
}

// TypeName provides a mock function for the type SectionInfo
func (_mock *SectionInfo) TypeName() string {
	ret := _mock.Called()
...
func (_c *SectionInfo_TypeName_Call) Return(s string) *SectionInfo_TypeName_Call {
	_c.Call.Return(s)
	return _c
}
