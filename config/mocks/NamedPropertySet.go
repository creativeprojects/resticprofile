...
// Description provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) Description() string {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_Description_Call) Return(s string) *NamedPropertySet_Description_Call {
	_c.Call.Return(s)
	return _c
}
...
// IsAllOptions provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) IsAllOptions() bool {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_IsAllOptions_Call) Return(b bool) *NamedPropertySet_IsAllOptions_Call {
	_c.Call.Return(b)
	return _c
}
...
// IsClosed provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) IsClosed() bool {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_IsClosed_Call) Return(b bool) *NamedPropertySet_IsClosed_Call {
	_c.Call.Return(b)
	return _c
}
...
// Name provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) Name() string {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_Name_Call) Return(s string) *NamedPropertySet_Name_Call {
	_c.Call.Return(s)
	return _c
}
...
// OtherPropertyInfo provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) OtherPropertyInfo() config.PropertyInfo {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_OtherPropertyInfo_Call) Return(propertyInfo config.PropertyInfo) *NamedPropertySet_OtherPropertyInfo_Call {
...
// Properties provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) Properties() []string {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_Properties_Call) Return(strings []string) *NamedPropertySet_Properties_Call {
...
// PropertyInfo provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) PropertyInfo(name string) config.PropertyInfo {
...
func (_c *NamedPropertySet_PropertyInfo_Call) Return(propertyInfo config.PropertyInfo) *NamedPropertySet_PropertyInfo_Call {
	_c.Call.Return(propertyInfo)
	return _c
}

func (_c *NamedPropertySet_PropertyInfo_Call) RunAndReturn(run func(name string) config.PropertyInfo) *NamedPropertySet_PropertyInfo_Call {
	_c.Call.Return(run)
	return _c
}

// TypeName provides a mock function for the type NamedPropertySet
func (_mock *NamedPropertySet) TypeName() string {
	ret := _mock.Called()
...
func (_c *NamedPropertySet_TypeName_Call) Return(s string) *NamedPropertySet_TypeName_Call {
	_c.Call.Return(s)
	return _c
}
